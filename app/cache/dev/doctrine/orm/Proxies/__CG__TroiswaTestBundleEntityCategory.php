 ...
 */
class Category extends \Troiswa\TestBundle\Entity\Category implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'nom', 'description', 'slug', 'news');
        }
    ...
    public function slugify($string)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'slugify', array($string));
