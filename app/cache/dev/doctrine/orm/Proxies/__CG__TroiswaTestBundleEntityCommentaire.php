 ...
 */
class Commentaire extends \Troiswa\TestBundle\Entity\Commentaire implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'texte', 'date', 'auteur', 'news');
        }
