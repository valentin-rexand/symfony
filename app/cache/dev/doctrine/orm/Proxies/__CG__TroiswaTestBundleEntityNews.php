 ...
 */
class News extends \Troiswa\TestBundle\Entity\News implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'titre', 'texte', 'date', 'auteur', 'slug', 'category', 'commentaires');
        }
